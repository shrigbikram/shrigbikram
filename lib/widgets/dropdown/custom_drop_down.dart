...
class CustomDropDown  extends StatefulWidget {
  ...
  CustomDropDown({this.items,this.height,this.width,this.value,this.hintText="0",this.callback});
                          ...
                          itemBuilder: (BuildContext ctxt, int index) {
                            return GestureDetector(
                              child:  Padding(
                                ...
                                child: Text(widget.items[index].label.toString(),style:Theme.of(context).textTheme.body1.copyWith(fontWeight: FontWeight.w400)),
                              ),

                              onTap: (){
                                widget.callback(widget.items[index].value.toString());
